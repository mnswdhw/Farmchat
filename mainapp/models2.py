...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        # resnet.fc = nn.Linear(num_ftrs, 38)
        # resnet.load_state_dict(torch.load('/content/gdrive/MyDrive/Kaggle/saved_weights/1epochresnet18.pth'))
...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=2048, dropout=0.5):
        ...
        # in case of one-hot embed dimension = vocabsize = 112 in our case
    ...
    def init_hidden_state(self, encoder_out):
        ...
        """
        mean_encoder_out = encoder_out.mean(
            dim=1)  # (batch_size, encoder_dim) this is the average of all the pixels of all the 2048 channels
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths):
        ...
        # print("decode_length:",max(decode_lengths))
